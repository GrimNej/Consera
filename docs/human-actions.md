...
| ---- | ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | -------------- | ------------ | ----------- | ---------------------------------------------------------- |
| H-01 | Create/confirm public GitHub repository `consera` and authorize remote integration | Requires account ownership and OAuth/visibility choices                           | ready_for_user | 2026-07-18   | —           | `pnpm github:verify-h01` is ready after one bootstrap push |
