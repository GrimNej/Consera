...
| H-03 | Create/select Consera LingoQL project and connect repository                       | Requires LingoQL account authorization                                            | verification_pending | 2026-07-18   | —                    | Runtime proves `0.0.0.0:8080` readiness, but root and health URLs return `502`; platform routing diagnosis pending |
