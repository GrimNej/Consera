...
| H-03 | Create/select Consera LingoQL project and connect repository                       | Requires LingoQL account authorization                                            | verification_pending | 2026-07-18   | —                    | Server was deployed, external health was `502`, then stopped for credit control; no redeploy without a budget window |
