...
| ---- | ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ---------------- | ------------ | ----------- | ---------------------------------------------------------- |
| H-01 | Create/confirm public GitHub repository `consera` and authorize remote integration | Requires account ownership and OAuth/visibility choices                           | waiting_for_user | 2026-07-18   | —           | `pnpm github:verify-h01` is ready after one bootstrap push |
...
completed_tests:
  ...
  - pnpm build
next_command: git remote add origin <sanitized GitHub clone URL>
expected_files:
  - docs/human-actions.md
  - docs/platform-evidence/2026-07-18_phase0-local-baseline.md
verification_criterion: origin/main contains the local bootstrap commit and the GitHub API reports public visibility
```
